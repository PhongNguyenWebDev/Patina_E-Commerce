        ...
        <form class="row" method="POST" action="{{ route('admin.coupons.store') }}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="code"
                        value="{{old('code')}}" placeholder="Nhập Code">
                    @error('code')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="usage_limit" name="usage_limit" value="{{old('usage_limit')}}" placeholder="Nhập giới hạn coupon">
                    @error('usage_limit')

        ...
        <form class="row" method="POST" action="{{ route('admin.coupons.update', $coupon) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="discount_type" name="discount_type">
                        @foreach ($discount_type as $type)
                            <option value="{{ $type }}" {{ $type == $coupon->discount_type ? 'selected' : '' }}>{{ $type }}</option>
                        @endforeach
                    </select>
                    @error('discount_type')
                        <span style="color: red"><i class="fa-solid fa-circle-exclamation fa-beat"></i>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="class" value="{{$coupon->min_price}}" name="min_price" placeholder="Nhập giá tối thiểu để được sử dụng voucher">
                    @error('min_price')
                        <span style="color: red"><i class="fa-solid fa-circle-exclamation fa-beat"></i>
                            {{ $message }}</span>
                    @enderror
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="class" value="{{$coupon->max_price}}" name="max_price" placeholder="Nhập giá giảm tối đa để được sử dụng voucher">
                    @error('max_price')
                        <span style="color: red"><i class="fa-solid fa-circle-exclamation fa-beat"></i>
                            {{ $message }}</span>
                    @enderror
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="usage_limit" value="{{$coupon->usage_limit}}" name="usage_limit" placeholder="Nhập giới hạn coupon">
                    @error('usage_limit')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" id="user_specific" name="user_specific">
                            ...
                            <option value="1" {{ $coupon->user_specific == 1 ? 'selected' : '' }}>Người dùng đã lưu</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">

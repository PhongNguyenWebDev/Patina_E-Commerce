                ...
                <div class="border rounded-3 p-4 mx-auto" style="width: 400px;">
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control form-control-login" id=""
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control form-control-login" id="exampleInputEmail1"
                        ...
                        <a href="{{ route('client.signIn-page') }}" class="text-decoration-none">
